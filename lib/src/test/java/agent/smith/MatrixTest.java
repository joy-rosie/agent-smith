...
public class MatrixTest {
    ...
    public static class CreateFromArrayExceptionArgumentsProvider implements ArgumentsProvider {
    ...
    @ParameterizedTest
    @ArgumentsSource(CreateFromArrayExceptionArgumentsProvider.class)
    ...
    public static class CreateFromArrayArgumentsProvider implements ArgumentsProvider {

        @Override
        public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
            return Stream.of(
                    // singleton
                    Arguments.of(new double[]{ 0 }, 1, 1, new double[] { 0 }, 1, 1)
                    // square
                    , Arguments.of(new double[]{ 1, 2, 3, 4 }, 2, 2, new double[]{ 1, 2, 3, 4 }, 2, 2)
                    // rectangle
                    , Arguments.of(new double[]{ 1, 2, 3, 4, 5, 6 }, 2, 3, new double[]{ 1, 2, 3, 4, 5, 6 }, 2, 3)
                    , Arguments.of(new double[]{ 1, 2, 3, 4, 5, 6 }, 3, 2, new double[]{ 1, 2, 3, 4, 5, 6 }, 3, 2)
            );
        }
    }

    @ParameterizedTest
    @ArgumentsSource(CreateFromArrayArgumentsProvider.class)
    public void testCreateFromArrayException(double[] array, int numRows, int numCols, double[] expectedArray,
...
//            public class FromArrayMatrixIllegalArgumentExceptionTest {
//
//                @Parameters
//                public static Iterable<Object[]> data() {
//                    return Arrays.asList(new Object[][]{
//                            // numRows <= 0
//                            { new double[]{ 0 }, -1, 1, "'numRows' (-1) has to be a positive integer" },
//                            { new double[]{ 0 }, 0, 1, "'numRows' (0) has to be a positive integer" },
//                            // numCols <= 0
//                            { new double[]{ 0 }, 1, -1, "'numCols' (-1) has to be a positive integer" },
//                            { new double[]{ 0 }, 1, 0, "'numCols' (0) has to be a positive integer" },
//                            // array == null
//                            { null, 1, 1, "'array' cannot be null" },
//                            // numRows * numCols > array.length
//                            { new double[]{ 1, 2 }, 2, 2,
//                                    "Length of 'array' (2) does not match 'numRows' * 'numCols' (4)" },
//                            // numRows * numCols < array.length
...
//
//                public FromArrayMatrixIllegalArgumentExceptionTest(double[] array, int numRows, int numCols, String expected) {
//                    this.array = array;
...
//                public void test() {
//                    Exception thrown = assertThrows(MatrixIllegalArgumentException.class,
//                            () -> Matrix.create(this.array, this.numRows, this.numCols));
...
//                    return Arrays.asList(new Object[][]{
//                            // square
//                            { new double[]{ 1, 2, 3, 4 }, 2, 2,  new double[]{ 1, 2, 3, 4 }, 2, 2 },
//                            // rectangle
//                            { new double[]{1, 2, 3, 4, 5, 6}, 2, 3, new double[]{1, 2, 3, 4, 5, 6}, 2, 3 },
//                            { new double[]{1, 2, 3, 4, 5, 6}, 3, 2, new double[]{1, 2, 3, 4, 5, 6}, 3, 2 },
//                    });
//                }
//
//                private final double[] array;
...
//                private final int expectedNumRows;
//                private final int expectedNumCols;
//
//                public FromArray(double[] array, int numRows, int numCols, double[] expectedArray, int expectedNumRows,
//                            int expectedNumCols) {
//                    this.array = array;
//                    this.numRows = numRows;
//                    this.numCols = numCols;
...
//                    this.expectedNumCols = expectedNumCols;
//                }
//
//                @Test
//                public void test() {
//                    Matrix matrix = Matrix.create(this.array, this.numRows, this.numCols);
//                    assertArrayEquals(this.expectedArray, matrix.getArray(), 0.0);
//                    assertEquals(this.expectedNumRows, matrix.getNumRows());
//                    assertEquals(this.expectedNumCols, matrix.getNumCols());
//                }
//
//            }
//
